                            ...
                            <div class="posts-block col-lg-9 col-md-9 col-sm-9 col-xs-12">
								...
								<div class="bottom pull-right">
									<c:if test="${authUser.userLevel=='administer'}">
										<button id="notiWrite" type="submit" class="btn btn-color btn-normal btn-pad">수정</button>
...
$(document).ready(function() {
	...
	$("#notiWrite").on("click", function(){
		...
		if (title =="" || content=="") {
			...
			frm.attr("action", "${pageContext.request.contextPath}/cs/notice/modify?notiNo=${csVo.notiNo}&page=${pCri.page}&numPerPage=${pCri.numPerPage}");
			frm.submit();
		}
	});
});
